...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_line_1, 17, 116);
    ...
    lv_obj_set_pos(ui->screen_line_2, 140, 114);
    ...
    lv_img_set_src(ui->screen_img_1, &_060_0_alpha_100x100);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 300);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 76, 259);
    ...
    lv_obj_set_pos(ui->screen_slider_1, 44, 211);
    lv_obj_set_size(ui->screen_slider_1, 160, 11);
